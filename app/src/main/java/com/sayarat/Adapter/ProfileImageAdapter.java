...
public class ProfileImageAdapter extends RecyclerView.Adapter<ProfileImageAdapter.ImageAdapterViewHolder>{
    ArrayList<String> data  ;
    LayoutInflater layoutInflater ;
    Context context ;

    public ProfileImageAdapter(ArrayList<String> dta, Context context) {
        this.data = dta;
    ...
    public ImageAdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item_view = layoutInflater.inflate(R.layout.user_profile_picture_recycler_item,parent , false ) ;
    ...
    class  ImageAdapterViewHolder extends RecyclerView.ViewHolder{
       ImageView profileImg ;
        public ImageAdapterViewHolder(View itemView) {
            super(itemView);
            profileImg = (ImageView) itemView.findViewById(R.id.user_profile_picture_recycler_item);
        }
    }
